    ...
    <div class="main_container" >
        ...
        <div class="container_header_nav" >
            ...
            <div class="user_setting" >
                <a href="#" title="FlexiLoad Balance" ><i class="fab fa-foursquare"></i> FL Balance - 1200.00 </a>
                <a href="#" title="Mobile Banking Balance" ><i class="fas fa-mobile-alt"></i> MB Balance - 1200.00 </a>
                <a href="#" title="User" ><i class="far fa-user"></i> Admin <i class="fas fa-angle-down"></i></a>
            </div>
        </div>
        ...
        <div class="flexi_load_history-tbl .table-responsive" >
            <div class="container" >
                ...
                <div class="row" style="padding-top: 20px" >
                    <div class="col-lg-12" >
                        <table id="flexiLoadHistoryTbl" class="table table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Position</th>
